...
/** GitHub repository URL for this app (the browser extension itself). */
export const REPO_URL = 'https://github.com/AponAhmed/apitab';

/** The companion desktop app lives in a separate repo. */
export const SIBLING_REPO_URL = 'https://github.com/AponAhmed/apitab-desktop';
...
export const ABOUT = {
  ...
  links: [
    ...
    { label: 'Desktop app repo', url: SIBLING_REPO_URL },
  ] satisfies AboutLink[],
