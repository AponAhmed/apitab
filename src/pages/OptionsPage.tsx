    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-200">
      <div className="mx-auto max-w-2xl px-5 py-8">
        ...
        <div className="space-y-4">
          ...
          <Section
            title="Data"
            description="Collections, environments, history and settings are stored locally in your browser."
          >
          ...
          <Section title="About & Developers">
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400">
                ApiTab v{browser.runtime.getManifest().version} · {ABOUT.license} License
              </p>
            </div>
          </Section>
        </div>
